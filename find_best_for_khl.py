...
#    veikkausliiga_my_simple = play(1000, estimator.simple_estimation, betting_strategy.kelly_div_10, league=u'Veikkausliiga', start='2010-01-01')
    ...
    POPULATION_SIZE = 4
    MUTATION_FREQUENCY = 100 # percentages of objects mutated
    
    ESTIMATOR = estimator_module.direct

    BETTING_STRATEGY = betting_strategy.kelly_div_10 # betting_strategy.div_10, betting_strategy.div_100, betting_strategy.bet_2, betting_strategy.bet_10
    ...
    while True:
        ...
        for idx, elem in enumerate(population):
            ...
            print 'winnings:', sorted(winnings)
            population[idx][1] = median(winnings)
            print 'MEDIAN:', population[idx][1]
