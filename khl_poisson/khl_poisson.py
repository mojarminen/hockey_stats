...
if __name__ == '__main__':
    ...
    get_estimations('Amur Khabarovsk', 'Barys Astana', games)
    get_estimations('Vladivostok', 'Yekaterinburg', games)
    get_estimations('Kunlun', 'HC Yugra', games)
    get_estimations('Metallurg Novokuznetsk', 'Din. Minsk', games)
    get_estimations('Sibir Novosibirsk', 'Dinamo Riga', games)
    get_estimations('Avangard Omsk', 'Jokerit', games)
    get_estimations('Medvescak Zagreb', 'Tractor Chelyabinsk', games)
    get_estimations('Lada', 'CSKA Moscow', games)
    get_estimations('Lokomotiv Yaroslavl', 'Sochi', games)
    get_estimations('Cherepovets', 'Podolsk', games)
    get_estimations('Dyn. Moscow', 'Sp. Moscow', games)
    get_estimations('Slovan Bratislava', 'Salavat Ufa', games)
