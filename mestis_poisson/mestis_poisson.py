...
DATAFILES = [
        'mestis_regular_season_2016-2017.csv',
    ]

TEAMS = {
    'Espoo United': 'Espoo United',
    'Hermes': 'Hermes',
    'Hokki': 'Hokki',
    'IPK': 'IPK',
    'Jokipojat': 'Jokipojat',
    'JYP-Academy': 'JYP-Academy',
    'K-Vantaa': 'K-Vantaa',
    'KeuPa': 'KeuPa',
    'LeKi': 'LeKi',
    'Peliitat': 'Peliitat',
...
if __name__ == '__main__':
    ...
    get_estimations('Hermes', 'Espoo United', games)
    get_estimations('Hokki', 'KeuPa', games)
    get_estimations('JYP-Academy', 'LeKi', games)
    get_estimations('K-Vantaa', 'IPK', games)
    get_estimations('SaPKo', 'RoKi', games)
    get_estimations('TUTO', 'Jokipojat', games)
