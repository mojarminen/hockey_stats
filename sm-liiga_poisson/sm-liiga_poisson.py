...
DATAFILES = [
#        'chl_2016-2017.csv', 
#        'sm-liiga_harjoitusottelut_2016.csv', 
#        'sm-liiga_regular_season_2016_spring.csv',
        'sm-liiga_regular_season_2016-2017.csv',
    ]
...
if __name__ == '__main__':
    ...
    get_estimations(u'Ässät', 'KooKoo', games)
    get_estimations('HPK', 'JYP', games)
    get_estimations(u'Kärpät', 'Ilves', games)
    get_estimations('Pelicans', 'KalPa', games)
    get_estimations('SaiPa', 'HIFK', games)
    get_estimations('Tappara', 'Lukko', games)
    get_estimations('Sport', 'Jukurit', games)
